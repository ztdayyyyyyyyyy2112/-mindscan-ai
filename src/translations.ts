export const translations = {
  vi: {
    ...
    questions: {
      ...
      q7: "7. Mức độ lo âu (Anxiety: 0 - 10)?",
      q8: "8. Mức độ trầm cảm (Depression: 0 - 10)?",
      q9: "9. Sự tự tin (Self Esteem: 0 - 10)?",
  ...
  en: {
    ...
    questions: {
      ...
      q7: "7. Anxiety level (0 - 10)?",
      q8: "8. Depression level (0 - 10)?",
      q9: "9. Self Esteem score (0 - 10)?",
  ...
  de: {
    ...
    questions: {
      ...
      q7: "7. Angstniveau (Anxiety: 0 - 10)?",
      q8: "8. Depressionsniveau (Depression: 0 - 10)?",
      q9: "9. Selbstwertgefühl (Self Esteem: 0 - 10)?",
    ...
    results: {
      ...
      viewFullLog: "Vollständiges Protokoll anzeigen",
      modelVersion: "Modellversion"
    },
    modals: {
      close: "Schließen",
      privacyTitle: "Datenschutzerklärung",
      ethicsTitle: "Forschungsethik"
    },
    emergency: {
